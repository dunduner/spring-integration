...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements service.HelloWorldService {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (service.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                service.HelloWorldSoapBindingStub _stub = new service.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
